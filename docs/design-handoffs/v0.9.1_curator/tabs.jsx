...
// ── Home tab ──
function HomeTab({ data, donated, currentMonth, onJump, onToggle, showLeavingShelf = true, showNewShelf = true }) {
...
function CategoryTab({ category, items, donated, onToggle, currentMonth, search }) {
